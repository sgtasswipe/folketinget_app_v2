import { View, Text, Pressable, FlatList, StyleSheet, StatusBar, TextInput, Modal, Alert } from 'react-native';
...
export default function HomeScreen({navigation}) {
  ...
  const performSearch = async () => {
    ...
    try {
      ...
      const response = await fetch('http://192.168.0.111:5001/search', {
        method: 'POST',
        headers: {
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.optionGroup}>
              <Text style={styles.optionLabel}>Antal resultater: {matchCount}</Text>
              <Slider
                style={styles.slider}
                minimumValue={1}
                maximumValue={50}
            ...
            <View style={styles.optionGroup}>
              <Text style={styles.optionLabel}>Matchgrænse (relevans): {matchThreshold.toFixed(2)}</Text>
              <Slider
                style={styles.slider}
                minimumValue={0}
                maximumValue={1}
