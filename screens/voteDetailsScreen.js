    ...
    return (
        <ScrollView style={styles.screen} contentContainerStyle={styles.contentContainer}>
            ...
            <View style={styles.section}>
                ...
                <Text style={[styles.sectionSubHeader, { marginTop: 10 }]}>For – Partier</Text>
                {inFavorList?.length > 0 ? (
                    inFavorList.map((p, i) => (
                        <Text key={i} style={styles.metaText}>• {p}</Text>
                    ))
                ) : (
                    <Text style={styles.metaText}>Ingen data</Text>
                )}

                <Text style={[styles.sectionSubHeader, { marginTop: 10 }]}>Imod – Partier</Text>
            ...
            <View style={styles.section}>
                ...
                <Text style={styles.metaText}>
                    <Text style={styles.metaLabel}>Afstemningsdato:</Text> {formatDate(dato)}
                </Text>
                <Text style={styles.metaText}>
                    <Text style={styles.metaLabel}>Opdateret:</Text> {formatDate(opdateringsdato)}
                </Text>
            </View>
